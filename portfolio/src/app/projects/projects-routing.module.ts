    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "pokemonteam/new",
            component: PokemonTeamBuilderComponent,
            data: {
              breadcrumb: "Pokemon Builder",
            },
          },
          {
            path: "pokemonteam/:id/edit",
            component: PokemonTeamBuilderComponent,
            canActivate: [AuthGuard],
            data: {
              breadcrumb: "Pokemon Builder",
          ...
          },
          {
            ...
            data: { signup: true, breadcrumb: "Sign Up" },
          },
          {
            path: "login",
            component: LoginComponent,
            data: { signup: false, breadcrumb: "Login" },
          },
          {
            path: "profile",
