  ...
  public projects: any[] = [
    {
      ...
      "state": {
        ...
        Greenhouse Effect, this is likely to create a rise in the temperature of the Earth over time."
      }
    },
    {
      ...
      "state": {
        ...
        over time. You can see that for very high temperature and very low temperature climates, for example Kuwait and Greenland, the max has had a spike\
        in the last decades. Interesting, the trend is more difficult to see in places of less extreme weather. It is difficult\
        to say whether climate change affects global temperature patterns uniformly on an average monthly scale. In the\
        future I'd like to investigate a data set that provides a daily average for countries, which might give more insight into\
        max temperature anomalies. This data was taken from https://www.kaggle.com/berkeleyearth/climate-change-earth-surface-temperature-data."
      }
    }
  ]
